...
export default {
  ...
  data() {
    return {
      products: [],
      // product: { productname: "", title: "", image: "" },
      activeItem: null,
      file: "",
      filed: null,
      page: 1,
  ...
  methods: {
    ...
    async adminProduct() {
      ...
      if (
        ...
        try {
          ...
          await AuthenticationServices.intproduct(formData);
        } catch (error) {
    ...
    async updateProduct() {
      ...
      if (
        ...
        formData.append("productname", this.productname);
        formData.append("name", this.title);
        await AuthenticationServices.updaateint(this.activeItem, formData);
      }
    },
    editProduct(product) {
    ...
    async deleteProduct(_id) {
      await AuthenticationServices.deleteintproduct(_id);
    },
    addNew() {
      this.reset();
