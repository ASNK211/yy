        ...
        <div class="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
          ...
          <div class="flex items-start mt-8">
            ...
            <p class="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">
              ادخل لحسابك الان واحصل على افضل العروض ل العابك المفضله مع زول قيم
              ، تواصل معنا دائماً عبر منصات التواصل الاجتماعي تحت وسوف نكون
              موجودين ل اي استفسار عزيزي المستخدم
            </p>
          </div>
        </div>
      </div>
